---
layout: post
title: "Working with Docker Client, Registry, Images, and Dockerfile"
date: 2026-04-23
categories:
  - Docker
tags:
...
![alt text]({{ '/assets/postimg/dockerclient.png' | relative_url }})
...
![alt text]({{ '/assets/postimg/clientconfig.png' | relative_url }})
...
![alt text]({{ '/assets/postimg/registry.png' | relative_url }})
...
- Images are multi-layered storage units where each layer represents changes made by commands; only the top layer is writable when running a container.
  ...
  ![alt text]({{ '/assets/postimg/layered.png' | relative_url }})
